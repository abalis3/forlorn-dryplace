...
g++ -std=c++17 -mmacosx-version-min=${OSX_DEPLOYMENT_TARGET} -DOSX_RELEASE_BUILD -DRAYLIB_CPP_NO_MATH=1 -framework CoreVideo -framework IOKit -framework Cocoa -framework GLUT -framework OpenGL -I ../vcpkg_installed/${VC_TUPLE}/include/ -I include ../vcpkg_installed/${VC_TUPLE}/lib/*.a -I ../shared-src/ src/*.cpp ../shared-src/*.cpp src/pbuf/generated/*.cc ../shared-src/pbuf/generated/*.cc -o bin/forbidden-desert
